...
class Box:
    ...
    def render(self,
               ...
               colors: Tuple = ('b', 'r', 'k'),
               linewidth: float = 2,viewsight='top'):
        """
        ...
        elif viewsight=='front':
            corners = view_points(self.corners(), view, normalize=normalize)[[0,2], :]
        elif viewsight=='side':
            corners = view_points(self.corners(), view, normalize=normalize)[[1,2], :]
